...
extern uint16_t FilteredCharHandle;        // <-- 你新增的 characteristic handle
extern tBleStatus Update_FilteredData(float x, float y, float z);  // <-- 更新函式

volatile uint8_t request_free_fall_notify = TRUE;
